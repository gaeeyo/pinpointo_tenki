...
//						throw new YahooWeatherParseException(12);
                            ...
                            hour.setImageUrl(supportOldAndroid(mUrl.group(1)));
                        }
                        break;
                    case 2:    // 気温
                        hour.temp = text;
            ...
            for (int c = 0; c < 7; c++) {
                ...
                switch (r) {
                    ...
                    case 1:    // 天気
                        ...
                        Matcher mUrl = pUrl.matcher(cm.group(1));
                        if (mUrl.find()) {
                            day.imageUrl = supportOldAndroid(mUrl.group(1));
    ...
    public static class YahooWeatherParseException extends Exception {
        ...
        public String getMessage() {
            return String.format(Locale.ENGLISH, "HTMLの処理エラー:%d", errorCode);
        }
    }
    ...
    public static class Hour {
        ...
        public String toString() {
            return String.format(Locale.ENGLISH, "%d時 %s,%s,%s,%s,%s,%s",
